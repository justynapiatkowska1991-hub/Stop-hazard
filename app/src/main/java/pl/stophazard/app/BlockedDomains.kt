...
object BlockedDomains {
    private val builtIn = setOf(
        ...
        "gamdom.com","duelbits.com","nitrobetting.eu","gg.bet","fortunejack.com",
        "888casino.com","partypoker.com","pokerstarscasino.com","casino.com","videoslots.com",
        "jackpotcity.com","royalpanda.com","spinpalace.com","betonline.ag","sportsbetting.ag",
        "mybookie.ag","superbahis.com","1win.pro","mostbet.com"
    )
    fun normalize(host:String):String=host.trim().lowercase().removePrefix("www.").substringBefore("/")
